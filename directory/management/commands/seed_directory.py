...
CATEGORIES = [
    ...
    ("Well Cleaning", "കിണർ ശുചീകരണം", "https://img.icons8.com/fluency/96/water-well.png", "well cleaning"),
    ("Bike Mechanic", "ബൈക്ക് മെക്കാനിക്", "https://img.icons8.com/fluency/96/motorcycle.png", "bike repair"),
    ("Pump Repair", "വാട്ടർ പമ്പ് റിപ്പയർ", "https://img.icons8.com/fluency/96/water-tap.png", "pump repair"),
